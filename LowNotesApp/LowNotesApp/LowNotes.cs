...
namespace LowNotesApp
{
    ...
    public class LowNotes : ISynthPlugin
    {

        public string Name => "Low notes";
        public string Description => "Plugin with low notes";
        public float C => getInfo("C");
        public float C_S => getInfo("C_S");
        public float D => getInfo("D");
        public float D_S => getInfo("D_S");
        public float E => getInfo("E");
        public float F => getInfo("F");
        public float F_S => getInfo("F_S");
        public float G => getInfo("G");
        public float G_S => getInfo("G_S");
        public float A => getInfo("A");
        public float A_S => getInfo("A_S");
        public float B => getInfo("B");
